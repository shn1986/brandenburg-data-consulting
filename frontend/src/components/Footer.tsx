...
const navigation = {
  ...
  services: [
    { name: 'Data Modeling', href: '/services#data-modeling' },
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              Transforming complex data challenges into strategic business advantages through expert consulting 
              in data modeling, AI solutions, and comprehensive analytics.
            </p>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="flex flex-col items-center justify-between lg:flex-row">
            <p className="text-xs leading-5 text-gray-400">
              &copy; {new Date().getFullYear()} Brandenburg Data Consulting Consulting. All rights reserved.
            </p>
            <div className="mt-4 flex space-x-4 lg:mt-0">
              <Link href="/contact" className="text-xs leading-5 text-gray-400 hover:text-white">
                hello@brandenburgdata.com
              </Link>
              <span className="text-gray-400">•</span>
              <span className="text-xs leading-5 text-gray-400">+1 (555) 123-4567</span>
            </div>
          </div>
        </div>
      </div>
